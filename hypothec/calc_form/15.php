...
<div class="form-group text-danger">
	...
	<div class="col-sm-7">																			  		  
			<div class="checkbox">
				<label><input type="checkbox" name="ins_prog_1" class="ins_prog" value="1"><small><b>Имущественное страхование</b></small></label>
			</div>
			<div class="checkbox">
				<label><input type="checkbox" name="ins_prog_2" class="ins_prog" value="2"><small><b>Страхование титула</b></small></label>
			</div>
			<div class="checkbox">
				<label><input type="checkbox" name="ins_prog_3" class="ins_prog" value="3"><small><b>Личное страхование</b></small></label>
			</div>										
	</div>
</div>
	...
	<div class="panel panel-default">
		...
		<div class="form-group ">
			...
			<div class="col-sm-7">
				...
				<div class="checkbox">
					<label><input type="checkbox" name="ins_property_type_2" class="ins_property_type" value="2"><small>Страхование недвижимого имущества - земельные участки</small></label>
				</div>		
			</div>
		</div>
		...
		<div id="ins_type_2" style="display:none">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="panel-title"><em>Страхование недвижимого имущества - земельные участки</em></div>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label  class="col-sm-5 control-label" ><small>Размер страховой суммы:</small></label>
					...
					<hr>
					<div class="form-group">
						<label  class="col-sm-5 control-label" ><small>Дополнительные риски:</small></label>
						<div class="col-sm-4">					
							<div class="checkbox">

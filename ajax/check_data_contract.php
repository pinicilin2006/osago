...
if($_SESSION['step_1']['place_reg'] == '1' && $auto_reg_number != 'Отсутствует'){
	...
	$num_format_2 = "/^[0-9]{4}[а-яА-Я]{2}[0-9]{2,3}$/u";
	if((!preg_match($num_format, $auto_reg_number) && $_SESSION['step_1']['category'] > 1) || (!preg_match($num_format_2, $auto_reg_number) && $_SESSION['step_1']['category'] == 1)){

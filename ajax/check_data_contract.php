...
//Проверка на соответствие территории преимущественного страхования и места жительства (регистрации) собственика
// if($_SESSION['step_1']['place_reg'] == '1' && $_SESSION['step_1']['citizenship'] == '1'){
// 	//Проверяем регион
// 	$owner_subject = ($insisown == 2 ? $owner_subject : $subject);//id_fias собственника
// 	$auto_subject_data = mysql_fetch_assoc(mysql_query("SELECT * FROM `kt_subject` WHERE `id` = '".$_SESSION['step_1']['subject']."'"));
// 	$auto_subject = $subject_data['id_fias'];//id_fias территории преимущественного испоьзования ТС
// 	if($auto_subject != $owner_subject){
// 		$err_text .= "<li class=\"text-danger\">не совпадает</li>";
// 	}
// }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////

...
$return = '';
$query = mysql_query("SELECT `user`.user_id,first_name,second_name,third_name FROM `user`,`user_unit` WHERE `user_unit`.`unit_id` ='".$id."' AND user.user_id = user_unit.user_id ORDER BY `second_name`");

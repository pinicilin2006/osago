...
if(mysql_query("UPDATE `unit` SET `unit_full_name` = '".$unit_full_name."',`unit_city` = '".$unit_city."',`unit_address` = '".$unit_address."',`unit_parent_id` = '".$unit_parent_id."',`active` = '".$active."',`id_in_ibs` = '".$id_in_ibs."',`ibs_department_id` = '".$ibs_department_id."',`ibs_sales_channel_id` = '".$ibs_sales_channel_id."',`ibs_sales_point_id` = '".$ibs_sales_point_id."' WHERE `unit_id` = '".$unit_id."'")){

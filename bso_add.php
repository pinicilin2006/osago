		...
		<div class="col-md-12">
			<div class="panel panel-default">
	  			<div class="panel-heading">
	    			<h3 class="panel-title">Выдача бланков БСО</h3>
	  			</div>
...
//отображнеия либо диапазона либо единичного номера полиса
	$(document).on("change", "#range", function(){
		...
		var b = '';
		if(a == '1'){
			b = '<label class=\"control-label\" style=\"padding-top:0px\">Диапазон номеров</label> <input type=\"text\" name=\"bso_range_start\" class=\"range form-control input-sm\" placeholder=\"с\" style=\"height:25px\"> <input type=\"text\" class=\"range form-control input-sm\" name=\"bso_range_end\" placeholder=\"по\" style=\"height:25px\">';
		} else {
			b = '<label class=\"control-label\" style=\"padding-top:0px\">Номер бланка</label> <input type=\"text\" name=\"bso_number[]\" class=\"range form-control input-sm\" style=\"height:25px\" required> <span style="font-size:8px;top:0px" class="plus glyphicon glyphicon-plus"></span><br>';
		}
		$('#message_1').html(b);
	});
...
//добавление добавление поля с номером БСО
	$(document).on("click", ".plus", function(){
		var a = '<label class=\"control-label\" style=\"padding-top:0px\">Номер бланка</label> <input type=\"text\" name=\"bso_number[]\" class=\"range form-control input-sm\" style=\"height:25px\" required> <span style="font-size:8px;top:0px" class="plus glyphicon glyphicon-plus"></span><br>';
		$('#message_1').append(a);
	});
